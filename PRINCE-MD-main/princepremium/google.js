...
module.exports = {
    ...
    handler: async ({ socket, msg, sender, args, reply }) => {
        try {
            ...
            console.log("[𝗣𝗥𝗜𝗡𝗖𝗘-𝗠𝗗 GOOGLE] Fetching search results...");
            ...
            if (response.data && response.data.success && response.data.result) {
                ...
                console.log("[𝗣𝗥𝗜𝗡𝗖𝗘-𝗠𝗗 GOOGLE] Fetching live screenshot from Bing visual...");
                try {
                    ...
                    try {
                        ...
                        console.error("[𝗣𝗥𝗜𝗡𝗖𝗘-𝗠𝗗 GOOGLE] Fallback failed too:", fallbackError.message);
                        await socket.sendMessage(sender, { react: { text: "❌", key: msg.key } });
                    }
                }
            ...
            console.error("[𝗣𝗥𝗜𝗡𝗖𝗘-𝗠𝗗 GOOGLE] Main Error:", error.message);
            await socket.sendMessage(sender, { react: { text: "❌", key: msg.key } });
